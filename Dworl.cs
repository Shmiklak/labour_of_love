...
{
    public class Dworl : StoryboardObjectGenerator
    {
        [Configurable]
        ...
        public override void Generate()
        {
            ...
            camera.PositionX.Add(StartTime, 400)
                .Add(86899, 0, EasingFunctions.ExpoOut);
            camera.PositionY.Add(StartTime, -300)
                .Add(86899, 0, EasingFunctions.ExpoOut);
            camera.PositionZ.Add(StartTime, 100)
                .Add(86899, 250, EasingFunctions.ExpoOut)
                .Add(118899, 500, EasingFunctions.ExpoOut);
            ...
            for(int i = 0; i < 250; i ++)
            {
                ...
                switch(RandSprite)
            {
                case 1: naziSprite = "sb/star.png";
                break;
                case 2: naziSprite = "sb/l.png";
                break;
                ...
                Vector2 randXY = new Vector2(Random(-880, 880), Random(-440, 440));
                nazi1.Coloring
