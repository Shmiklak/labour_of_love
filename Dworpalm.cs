...
{
    public class Dworpalm : StoryboardObjectGenerator
    {
        [Configurable]
        ...
        public override void Generate()
        {
            ...
            for(int i = 0; i < 100; i ++)
            {
                ...
                int RandSprite = Random(1, 4);
                // int Rotate1 = Random(-2,2);
                switch(RandSprite)
            {
                case 1: naziSprite = "sb/palm_1.png";
                break;
                case 2: naziSprite = "sb/palm_2.png";
                break;
                case 3: naziSprite = "sb/palm_3.png";
                break;
                case 4: naziSprite = "sb/palm_4.png";
                break;
                ...
                Vector2 randXY = new Vector2(Random(-880, 880), Random(90, 90));
                nazi1.PositionX
